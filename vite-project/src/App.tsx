...
//You Must import this before the react-speech-recognition itself
		...
		<div className="w-full h-full grid place-items-center p-10">
			<div className="xl:w-[25vw] lg:w-[40vw] md:w-[60vw] w-[90%] flex flex-col shadow-lg bg-white p-5 rounded-lg relative">
				<div className="w-full h-[200px] relative pb-2 pt-8 font-medium text-gray-900 leading-7">
					...
					/>
					<VolumeHigh
						onClick={handleSpeakTranscript} cssClasses={`absolute bottom-0 left-0 ${
							transcript ? "cursor-pointer opacity-100" : "cursor-default opacity-50"
						} !fill-[#6c63fe]`}
					/>
					<select
			...
			<div className="p-10 ">
				<span >Click here   
			     <a  id="abhi" className="m-2" href="https://github.com/118abhi" target="blank" >Github</a>
				</span>
